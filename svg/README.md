...
2. Double-click on `index.html` (or `android-logo.html`) to view the assignment in your default web browser.
3. Alternatively, you can use the Live Server extension in VS Code or any local web server to serve the files.

## Description
This folder contains the HTML and CSS assignment files for the "svg" project.
